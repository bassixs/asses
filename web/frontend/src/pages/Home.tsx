...
const STEPS = [
  {
    n: "01",
    title: "Готовите упражнение",
    text: "Один раз заводите упражнение в каталоге: название, материалы (инструкции, методички) и пустой блокнот наблюдателя.",
  },
  {
    n: "02",
    title: "ИИ подтверждает понимание",
    text: "ИИ изучает материалы и блокнот и разбирает: кто ведущий, кто участник, что упражнение измеряет. Пока он не подтвердил понимание — упражнение в оценке недоступно.",
  },
  {
    n: "03",
    title: "Проводите оценку",
    text: "Создаёте центр, добавляете участников по коду (без ФИО), выбираете упражнение из каталога и загружаете запись — или сразу заполненный наблюдателем блокнот.",
  },
  {
    n: "04",
    title: "Отчёт и ИПР",
