...
async def callback_stt_provider(callback: CallbackQuery, session: AsyncSession) -> None:
    ...
    provider_name = "NeuroAPI Whisper" if provider == "neuroapi" else "Yandex"
