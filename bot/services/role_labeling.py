...
ВАЖНО про сегментацию:
Распознавание речи НЕ разделяет говорящих, поэтому одна входная строка часто склеивает реплики
РАЗНЫХ людей. Обязательно разрезай такие блоки на отдельные реплики там, где меняется говорящий:
- приветствия и ответы ("Здравствуйте, вызывали?" — это сотрудник; "Да, добрый день, Марина" — это руководитель);
- вопрос одного и ответ другого ("Что нужно сделать?" / "Нужно подготовить...");
- служебные фразы ведущего/ассессора ("Марина ушла", "Маргарита, задам вам вопросы");
- резкая смена позиции (управленческая постановка задачи ↔ жалобы и сопротивление сотрудника).
Не оставляй в одной реплике двух говорящих. Лучше больше коротких реплик, чем склейка.

Держи роли СОГЛАСОВАННЫМИ на протяжении всего текста и предыдущего контекста: один и тот же человек
не может быть то "участник", то "ведущий". Оцениваемый участник (руководитель, ставит задачи, ведёт
интервью, отвечает ассессору о своих целях) — всегда "участник"; ролевой сотрудник, который жалуется на
загрузку/усталость/отпуск и сопротивляется, — всегда "ведущий".
