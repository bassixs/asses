...
class Settings(BaseSettings):
    ...
    role_labeling_chunk_chars: int = Field(default=2500, validation_alias="ROLE_LABELING_CHUNK_CHARS")
    ...
    analysis_llm_provider: str = Field(default="neuroapi", validation_alias="ANALYSIS_LLM_PROVIDER")
    analysis_llm_model: str = Field(default="deepseek-v4-flash", validation_alias="ANALYSIS_LLM_MODEL")
